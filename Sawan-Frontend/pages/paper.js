...
import categoryImage from '../public/images/day34-ticket.png'
  ...
  <div className={style.category_container}>
    ...
    <div className={style.category_about}>
      <div className={style.category_heading}>
        <h2 className={style.header}>Welcome to Paper Section</h2>
...
<Head>
    ...
    <title>Welcome to Paper Section</title>
    <meta charSet="utf-8" />
...
<h1 className={styles.category_header}>Paper Crafts</h1>
