...
import categoryImage from '../public/images/day21-Lantern.png'
  ...
  <div className={style.category_container}>
    ...
    <div className={style.category_about}>
      <div className={style.category_heading}>
        <h2 className={style.header}>Welcome to Puzzle Section</h2>
...
<Head>
    ...
    <title>Welcome to Puzzle Section</title>
    <meta charSet="utf-8" />
  ...
  <div className={styles.card_section}>
    ...
    <h1 className={styles.category_header}>Puzzle Games</h1>
